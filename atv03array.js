...
// → Seu código aqui:
let cores = ["roxo", "verde", "vermelho", "rosa"]
const numeros = (1, 2, 3, 4, 5)

console.log("EX 1 ->",[cores[0], cores[3]]);
...
console.log("EX 3 -> Há ", cores.length, "cores aqui");
...
// → Seu código aqui:
let cores = ["roxo", "verde", "vermelho", "rosa", "dourado"]
const numeros = (1, 2, 3, 4, 5)

console.log("EX 4 a-> ", cores, numeros);
console.log("EX 4 b-> Há ", cores.length, "cores aqui");
